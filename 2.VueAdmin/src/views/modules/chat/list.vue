        ...
        >
          ...
          >
            <template slot-scope="scope">
              <el-button
                type="text"
				:style='{"border":"2px solid rgb(212, 216, 223)","cursor":"pointer","padding":"0 5px","margin":"0 5px 5px 0","outline":"none","color":"rgb(139, 154, 179)","borderRadius":"4px","background":"rgb(255, 255, 255)","width":"auto","fontSize":"13px","height":"32px"}'
                size="small"
