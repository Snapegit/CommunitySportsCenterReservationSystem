	...
	<div class="main-containers">
		...
		<div class="top-container" :style='{"boxShadow":"0 0px 0px rgba(64, 158, 255, .3)","padding":"0px 40px","borderColor":"#ccc","alignItems":"center","color":"#666","textAlign":"right","display":"flex","justifyContent":"flex-end","overflow":"hidden","top":"0","borderRadius":"0","left":"0","background":"#fff","borderWidth":"0 0 2px","width":"100%","fontSize":"14px","lineHeight":"80px","position":"fixed","borderStyle":"solid","height":"80px","zIndex":"1002"}'>
			...
			<div :style='{"margin":"0","alignItems":"center","left":"20px","background":"none","display":"flex","width":"30%","position":"absolute","float":"left","height":"80px"}'>
			  <span @click="goMenu('/index/home')" :style='{"padding":"0px","color":"rgb(17, 19, 40)","alignItems":"center","display":"flex","width":"100%","lineHeight":"1.5","fontSize":"18px","fontWeight":"600","height":"100%"}'>基于SpringBoot的小区运动中心预约管理系统的设计与实现</span>
			</div>
        ...
        <el-dialog title="意见反馈" :visible.sync="chatFormVisible" width="600px" :before-close="chatClose">
...
export default {
    data() {
		return {
            activeIndex: '0',
			roleMenus: [{"backMenu":[{"child":[{"allButtons":["新增","查看","修改","删除","首页总数"],"appFrontIcon":"cuIcon-taxi","buttons":["新增","查看","修改","删除","首页总数"],"menu":"用户","menuJump":"列表","tableName":"yonghu"}],"menu":"用户管理"},{"child":[{"allButtons":["新增","查看","修改","删除"],"appFrontIcon":"cuIcon-clothes","buttons":["新增","查看","修改","删除"],"menu":"收银员","menuJump":"列表","tableName":"shouyinyuan"}],"menu":"收银员管理"},{"child":[{"allButtons":["新增","查看","修改","删除","查看评论","首页总数","预约"],"appFrontIcon":"cuIcon-vip","buttons":["新增","查看","修改","删除","查看评论","首页总数"],"menu":"教练","menuJump":"列表","tableName":"jiaolian"}],"menu":"教练管理"},{"child":[{"allButtons":["新增","查看","修改","删除"],"appFrontIcon":"cuIcon-list","buttons":["新增","查看","修改","删除"],"menu":"场地类型","menuJump":"列表","tableName":"changdileixing"}],"menu":"场地类型管理"},{"child":[{"allButtons":["新增","查看","修改","删除","预约"],"appFrontIcon":"cuIcon-copy","buttons":["新增","查看","修改","删除"],"menu":"场馆信息","menuJump":"列表","tableName":"changguanxinxi"}],"menu":"场馆信息管理"},{"child":[{"allButtons":["新增","查看","修改","删除","支付"],"appFrontIcon":"cuIcon-paint","buttons":["查看","修改","删除"],"menu":"场馆预约","menuJump":"列表","tableName":"changguanyuyue"}],"menu":"场馆预约管理"},{"child":[{"allButtons":["新增","查看","修改","删除","支付"],"appFrontIcon":"cuIcon-goods","buttons":["查看","修改","删除"],"menu":"预约教练","menuJump":"列表","tableName":"yuyuejiaolian"}],"menu":"预约教练管理"},{"child":[{"allButtons":["新增","查看","修改","删除","预约"],"appFrontIcon":"cuIcon-circle","buttons":["查看","修改","删除","新增"],"menu":"球馆器材","menuJump":"列表","tableName":"qiuguanqicai"}],"menu":"球馆器材管理"},{"child":[{"allButtons":["新增","查看","修改","删除","支付","首页总数"],"appFrontIcon":"cuIcon-copy","buttons":["查看","修改","删除"],"menu":"器材预约","menuJump":"列表","tableName":"qicaiyuyue"}],"menu":"器材预约管理"},{"child":[{"allButtons":["新增","查看","修改","删除"],"appFrontIcon":"cuIcon-medal","buttons":["新增","查看","修改","删除"],"menu":"会员等级","menuJump":"列表","tableName":"huiyuandengji"}],"menu":"会员等级管理"},{"child":[{"allButtons":["新增","查看","修改","删除"],"appFrontIcon":"cuIcon-group","buttons":["查看","修改","删除"],"menu":"交流论坛","tableName":"forum"}],"menu":"交流论坛"},{"child":[{"allButtons":["查看","修改"],"appFrontIcon":"cuIcon-time","buttons":["查看","修改"],"menu":"关于我们","tableName":"aboutus"},{"allButtons":["新增","查看","修改","删除"],"appFrontIcon":"cuIcon-skin","buttons":["查看","修改"],"menu":"轮播图管理","tableName":"config"},{"allButtons":["查看","修改"],"appFrontIcon":"cuIcon-circle","buttons":["查看","修改"],"menu":"系统简介","tableName":"systemintro"},{"allButtons":["新增","查看","修改","删除"],"appFrontIcon":"cuIcon-news","buttons":["新增","查看","修改","删除"],"menu":"通知公告","tableName":"news"},{"allButtons":["新增","查看","修改","删除"],"appFrontIcon":"cuIcon-news","buttons":["新增","查看","修改","删除"],"menu":"通知公告分类","tableName":"newstype"},{"allButtons":["新增","查看","修改","删除"],"appFrontIcon":"cuIcon-service","buttons":["查看","修改","删除","新增"],"menu":"意见反馈","tableName":"chat"}],"menu":"系统管理"}],"frontMenu":[{"child":[{"allButtons":["新增","查看","修改","删除","查看评论","首页总数","预约"],"appFrontIcon":"cuIcon-send","buttons":["查看","查看评论","预约"],"menu":"教练列表","menuJump":"列表","tableName":"jiaolian"}],"menu":"教练模块"},{"child":[{"allButtons":["新增","查看","修改","删除","预约"],"appFrontIcon":"cuIcon-flashlightopen","buttons":["查看","预约"],"menu":"场馆信息列表","menuJump":"列表","tableName":"changguanxinxi"}],"menu":"场馆信息模块"},{"child":[{"allButtons":["新增","查看","修改","删除","预约"],"appFrontIcon":"cuIcon-shop","buttons":["查看","预约"],"menu":"球馆器材列表","menuJump":"列表","tableName":"qiuguanqicai"}],"menu":"球馆器材模块"}],"hasBackLogin":"是","hasBackRegister":"否","hasFrontLogin":"否","hasFrontRegister":"否","roleName":"管理员","tableName":"users"},{"backMenu":[{"child":[{"allButtons":["新增","查看","修改","删除","支付"],"appFrontIcon":"cuIcon-paint","buttons":["查看","删除","支付"],"menu":"场馆预约","menuJump":"列表","tableName":"changguanyuyue"}],"menu":"场馆预约管理"},{"child":[{"allButtons":["新增","查看","修改","删除","支付"],"appFrontIcon":"cuIcon-goods","buttons":["查看","删除","支付"],"menu":"预约教练","menuJump":"列表","tableName":"yuyuejiaolian"}],"menu":"预约教练管理"},{"child":[{"allButtons":["新增","查看","修改","删除","支付","首页总数"],"appFrontIcon":"cuIcon-copy","buttons":["查看","删除","支付"],"menu":"器材预约","menuJump":"列表","tableName":"qicaiyuyue"}],"menu":"器材预约管理"}],"frontMenu":[{"child":[{"allButtons":["新增","查看","修改","删除","查看评论","首页总数","预约"],"appFrontIcon":"cuIcon-send","buttons":["查看","查看评论","预约"],"menu":"教练列表","menuJump":"列表","tableName":"jiaolian"}],"menu":"教练模块"},{"child":[{"allButtons":["新增","查看","修改","删除","预约"],"appFrontIcon":"cuIcon-flashlightopen","buttons":["查看","预约"],"menu":"场馆信息列表","menuJump":"列表","tableName":"changguanxinxi"}],"menu":"场馆信息模块"},{"child":[{"allButtons":["新增","查看","修改","删除","预约"],"appFrontIcon":"cuIcon-shop","buttons":["查看","预约"],"menu":"球馆器材列表","menuJump":"列表","tableName":"qiuguanqicai"}],"menu":"球馆器材模块"}],"hasBackLogin":"否","hasBackRegister":"否","hasFrontLogin":"是","hasFrontRegister":"是","roleName":"用户","tableName":"yonghu"},{"backMenu":[{"child":[{"allButtons":["新增","查看","修改","删除","支付"],"appFrontIcon":"cuIcon-paint","buttons":["查看","修改","删除"],"menu":"场馆预约","menuJump":"列表","tableName":"changguanyuyue"}],"menu":"场馆预约管理"},{"child":[{"allButtons":["新增","查看","修改","删除","支付"],"appFrontIcon":"cuIcon-goods","buttons":["查看","修改","删除"],"menu":"预约教练","menuJump":"列表","tableName":"yuyuejiaolian"}],"menu":"预约教练管理"},{"child":[{"allButtons":["新增","查看","修改","删除","支付","首页总数"],"appFrontIcon":"cuIcon-copy","buttons":["查看","修改","删除"],"menu":"器材预约","menuJump":"列表","tableName":"qicaiyuyue"}],"menu":"器材预约管理"}],"frontMenu":[{"child":[{"allButtons":["新增","查看","修改","删除","查看评论","首页总数","预约"],"appFrontIcon":"cuIcon-send","buttons":["查看","查看评论","预约"],"menu":"教练列表","menuJump":"列表","tableName":"jiaolian"}],"menu":"教练模块"},{"child":[{"allButtons":["新增","查看","修改","删除","预约"],"appFrontIcon":"cuIcon-flashlightopen","buttons":["查看","预约"],"menu":"场馆信息列表","menuJump":"列表","tableName":"changguanxinxi"}],"menu":"场馆信息模块"},{"child":[{"allButtons":["新增","查看","修改","删除","预约"],"appFrontIcon":"cuIcon-shop","buttons":["查看","预约"],"menu":"球馆器材列表","menuJump":"列表","tableName":"qiuguanqicai"}],"menu":"球馆器材模块"}],"hasBackLogin":"是","hasBackRegister":"是","hasFrontLogin":"否","hasFrontRegister":"否","roleName":"收银员","tableName":"shouyinyuan"}],
			baseUrl: '',
			carouselList: [],
			menuList: [],
