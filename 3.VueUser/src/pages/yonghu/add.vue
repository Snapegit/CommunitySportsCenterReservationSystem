    ...
    methods: {
      ...
      init(type) {
        ...
        this.$http.get('option/huiyuandengji/huiyuandengji', {emulateJSON: true}).then(res => {
          if (res.data.code == 0) {
            this.huiyuandengjiOptions = res.data.data;
          }
        });
      ...
      // 下二随
      huiyuandengjiChange () {
        this.$http.get('follow/huiyuandengji/huiyuandengji?columnValue=' + this.ruleForm.huiyuandengji, {emulateJSON: true}).then(res => {
          if (res.data.code == 0) {
