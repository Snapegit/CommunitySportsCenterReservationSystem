<template>
<div class="forum-preview" :style='{"width":"100%","padding":"30px calc((100% - 1200px)/2) 40px","margin":"0px auto","position":"relative","background":"#fff"}'>
    <div :style='{"padding":"8px 0","margin":"30px auto 0","borderColor":"#E5E5E5","textAlign":"center","background":"#F5F5F5","borderWidth":"1px","width":"100%","borderStyle":"solid","height":"auto"}'>
